 ...
 * Generated at: 2017-10-12 14:19:11 UTC
...
public final class manager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/modal/manager-nav.jsp", Long.valueOf(1507698768520L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <li>\r\n");
      out.write("                        <div class=\"index-link\" id=\"jieyue-manager\"><i class=\"glyphicon glyphicon-user\"></i>借阅管理</div>\r\n");
      out.write("                    </li>\r\n");
      out.write("                    <li>\r\n");
      out.write("                        <div class=\"index-link\" id=\"book-manager\"><i class=\"glyphicon glyphicon-user\"></i>图书管理</div>\r\n");
      out.write("                    </li>\r\n");
      out.write("                    <li>\r\n");
      out.write("                        <div class=\"index-link\" id=\"personal\"><i class=\"glyphicon glyphicon-user\"></i>个人资料</div>\r\n");
      out.write("                    </li>\r\n");
      out.write("                </ul>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"container-fluid\">this is footer</div>\r\n");
      out.write("</div>\r\n");
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("    $(function(){\r\n");
      out.write("        $(\"#jieyue-manager\").click(function () {\r\n");
      out.write("            $.get(\"/hello\",function(data){\r\n");
      out.write("                console.log(data);\r\n");
      out.write("                $(\"#content\").html(data)\r\n");
      out.write("            })\r\n");
      out.write("        });\r\n");
      out.write("        $(\"#book-manager\").click(function(){\r\n");
      out.write("            $.post(\"/manager/book-manager\",function(data){\r\n");
      out.write("                $(\"#content\").html(data);\r\n");
      out.write("            });\r\n");
      out.write("        });\r\n");
      out.write("    })\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/modal/manager-nav.jsp(20,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("                <li>\r\n");
        out.write("                    <a class=\"btn\" href=\"/manager/login\">登录</a>\r\n");
        out.write("                </li>\r\n");
        out.write("            ");
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/modal/manager-nav.jsp(25,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("                <li>\r\n");
        out.write("                    <a class=\"btn\" href=\"/manager/logout\">退出登录</a>\r\n");
        out.write("                </li>\r\n");
        out.write("            ");
